        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-foreground/70">
              Capturing moments, designing experiences, and creating visual stories 
              that inspire and connect.
            </p>
            
            <div className="mt-6 flex gap-4">
              <a href="#" className="p-2 rounded-full bg-secondary/50 hover:bg-secondary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#social" className="text-foreground/70 hover:text-foreground transition-colors">Social Media</a></li>
